...
def color_filter(content: str):
	...
	content = content.replace("$bgbrightred$", bg.brightred)
	content = content.replace("$bgbrightgreen$", bg.brightgreen)
	content = content.replace("$bgbrightyellow$", bg.brightyellow)
	content = content.replace("$bgbrightblue$", bg.brightblue)
